...
const TodaysCard = () => {
  return (
    <div className="lg:flex space-y-4 lg:space-y-0 gap-5 justify-between   mt-10 bg-[#1A1D23] rounded-3xl p-4">
      ...
      <div className="flex items-center gap-5">
          ...
          <button className="btn bg-[#C2F800] border-none text-[15px] px-8 rounded-3xl "><MdDone className="text-[16px]"/>Mark as Done</button>
